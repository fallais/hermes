...
func (s *free) SendNotification(firstname, lastname string, birthdate time.Time) error {
	// Craft the message body
	body := "This is the birthday of " + firstname + " " + lastname + " ! " + strconv.Itoa(time.Now().Year()-birthdate.Year()) + " years old !"
